...
#    Updated: 2023/03/26 21:50:58 by yamrire          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = main.c ./parsing/parsing.c ./parsing//utils/ft_split.c ./parsing/utils/ft_strlen.c ./parsing/utils/ft_strnstr.c ./execution/utils.c ./execution/end_prog.c \
	...
	./parsing/split_arg.c ./execution/utils2.c ./parsing/utils2.c ./parsing/parsing_utils.c  #execution/signals.c 
NAME = minishell
CC = cc
FLAGS = -Wall -Werror -Wextra -lreadline
#CFLAGS = -Wall -g $(shell pkg-config --cflags readline)
#LDFLAGS = $(shell pkg-config --libs readline)
#LDFLAGS = -lreadline -L /Users/yamrire/goinfre/homebrew/opt/readline/lib -I /Users/yamrire/goinfre/homebrew/opt/readline/include -g #-fsanitize=address 
OBJ = $(SRC:%.c=%.o)
