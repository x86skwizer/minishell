...
#    Updated: 2023/03/21 04:20:42 by yamrire          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = main.c ./parsing/parsing.c ./parsing//utils/ft_split.c ./parsing/utils/ft_strlen.c ./parsing/utils/ft_strnstr.c \
	...
	./execution/builtins/unset.c ./execution/builtins/exit.c ./execution/utils/get_next_line.c ./execution/utils/heredoc.c
NAME = minishell
CC = cc
